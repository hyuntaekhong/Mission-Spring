...
<table border="1" style="width: 100%">
   <tr>
      <td rowspan="2" style="width:128px;">
         <a href="/Mission-Spring">
            <img src="/Mission-Spring/resources/images/logo.png"  style="width:128px;">
         </a>
      </td>
      <td align="right">
   ...
   <tr>
      <td>
         <nav>
         <c:if test="${ loginVO.type eq 's' or 'S' }">
            <a href="${ pageContext.request.contextPath }/">회원관리 </a> | 
         </c:if>         
